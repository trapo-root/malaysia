    ...
    jQuery.fn.beforeAfter = function(options) {
        ...
        function beforeAfter(that) {
            ...
            if (jQuery(that).children().length == 2) {
                ...
                left_arrow.setAttribute('style', 'height:20px;border:solid black;border-width:0 3px 3px 0;display:inline-block;padding:8px;transform:rotate(135deg);-webkit-transform:rotate(135deg);');

                var right_arrow = document.createElement("I");
                right_arrow.setAttribute('style', 'height:20px;border:solid black;border-width:3px 0 0 3px;display:inline-block;padding:8px;transform:rotate(135deg);-webkit-transform:rotate(135deg);');

                var separator_bullet = document.createElement("DIV");
                separator_bullet.setAttribute('style', 'position:absolute;width:80px;height:80px;line-height:55px;padding:18px;text-align:center;top:50%;left:50%;transform:translate(-50%,-50%);border-radius:50%;background-color:#fff;');
